...
{
    public class OrInstruction : VMInstruction
    {
        ...
        public OrInstruction(VMCompiler compiler, CilInstruction inst, CilLocalVariable? localVar)
        {
        ...
        {
            Console.WriteLine($"OR {ToPushReg.DataType}={Reg1.DataType}|{Reg2.DataType} {ToPushReg} {Reg1} {Reg2}");
