...
{
    public class SubInstruction : VMInstruction
    {
        ...
        public SubInstruction(VMCompiler compiler, CilInstruction inst)
        {
        ...
        {
            Console.WriteLine($"SUB {ToPushReg.DataType}={Reg1.DataType}-{Reg2.DataType} {ToPushReg} {Reg1} {Reg2}");
